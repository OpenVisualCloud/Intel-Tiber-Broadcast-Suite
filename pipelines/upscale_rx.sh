...
while getopts "lh" opt; do
    case ${opt} in
        l )
            ...
            ffmpeg -y \
                -p_port "${VFIO_PORT_R}" -p_sip 192.168.2.3 -p_rx_ip 192.168.2.2 -udp_port 20000 -payload_type 112 -fps 25 -pix_fmt yuv422p10le  -video_size 3840x2160 -f mtl_st20p -i "0" \
                src/recv-upscale.yuv
            exit 0
            ;;
        h )
            help
